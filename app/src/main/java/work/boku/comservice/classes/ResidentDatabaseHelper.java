...
//
//    public static final String DB_NAME = "residentDB.db"
//
//    public static final String TB_NAME = "Resident";
//
//    public static final String CREATE_RESIDENT_DB = "CREATE TABLE IF NOT EXISTS " + TB_NAME +
//            " (" +
//            "DB_rid INTEGER PRIMARY KEY AUTOINCREMENT, " +
//            "community_id TEXT, " +
...
//                int phone_number = cursor.getInt(cursor.getColumnIndex("phone_number"));
//
